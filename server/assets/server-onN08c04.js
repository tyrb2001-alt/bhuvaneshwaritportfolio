...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CQ2Jq24Q.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D6XvX5h8.js"),
    import("./start-B3woJQpm.js"),
...
var ROUTER_BASEPATH = "bhuvaneshwaritportfolio";
var SERVER_FN_BASE = "/bhuvaneshwaritportfolio/_serverFn/";
